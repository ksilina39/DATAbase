...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 4184837437821323936),
      name: 'Note',
      lastPropertyId: const IdUid(3, 5935418100886677622),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 2882027925188297831),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 5499797877007002584),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 5935418100886677622),
            name: 'description',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 4184837437821323936),
